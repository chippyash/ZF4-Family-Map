...
/**
 * Defines a Map Layer (google GLayer) for the GMap interface 
 *
 * Usage:
 ...
 * @subpackage  Layer
 */
class ZF4_GMap_Layer_Layer extends ZF4_Object_Virtual implements ZF4_GMap_Layer_Interface {
	 ...
	 * @param ZF4_Gmap_Marker $marker Handle to marker to use for layer.  GLayer does not require this
	 */
	public function toJScript(ZF4_GMap_Map $map, ZF4_Gmap_Marker $marker = null) {
		...
		$script = "_GMAP.{$layName} = new GLayer(\"{$this->layerName}\"); ";
