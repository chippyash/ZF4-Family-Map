...
/**
 * Defines a Map Layer (google GTrafficOverlay) for the GMap interface 
 *
 * Corresponds to ZF4_GMap::LAYER_TRAFFIC
 * 
 * @category 	ZF4
 * @package  	GMap
 * @subpackage  Layer
 */
class ZF4_GMap_Layer_Traffic 
	...
	/**
	 * Public variables are as for the GGeoXml properties
	 ...
	 * @param ZF4_Gmap_Marker $marker Handle to marker to use for layer.  Traffic layer does not require this
	 */
	public function toJScript(ZF4_GMap_Map $map, ZF4_Gmap_Marker $marker = null) {
		...
		$script = "_GMAP.{$layName} = new GTrafficOverlay({$options});";
